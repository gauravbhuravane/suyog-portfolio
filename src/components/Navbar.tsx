...
export function Navbar() {
  ...
  const navItems = ['Home', 'About', 'Skills', 'Resume', 'Certificates', 'Contact'];
      ...
      >
        <div className="relative w-full px-6 py-4 flex items-center justify-center">
          ...
          >
            {/* SB Logo */}
            <div 
              className="w-14 h-14 rounded-full flex items-center justify-center shrink-0 shadow-lg border-2 border-white/40"
              style={{ background: 'linear-gradient(135deg, #2563eb, #7e22ce)' }}
            >
              <span className="text-white font-bold text-2xl tracking-tighter">SB</span>
            </div>
